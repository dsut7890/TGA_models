...
erh2o0=5300;%5556; %h2o FIDDLED!!
erpyr0=2.7e4; %pyrolysis
erchar=9000; %char 
...
pars=[kh2o0;Akpyr0;erh2o0;erpyr0];
colours={'r','g','b','k'};

for jj=1:length(pars)
  for ii=1:nTol
    
    kh2o=(1+deltaFun(jj,1)*tol(ii))*pars(1);
    Akpyr=(1+deltaFun(jj,2)*tol(ii))*pars(2);
    erh2o=(1+deltaFun(jj,2)*tol(ii))*pars(3); 
    erpyr=(1+deltaFun(jj,2)*tol(ii))*pars(4); 
